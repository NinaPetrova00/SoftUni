...
export const UserRow = ({
    ...
    return (
        <Fragment>
            <td>
                <img src={imageUrl || blankProfileUrl} alt={`${firstName}'s profile`} className="image" />
            </td>
            <td>{firstName}</td>
            <td>{lastName}</td>
            <td>{email}</td>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onActionClick(_id, UserActionTypes.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onActionClick(_id, UserActionTypes.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onActionClick(_id, UserActionTypes.Details)}>
