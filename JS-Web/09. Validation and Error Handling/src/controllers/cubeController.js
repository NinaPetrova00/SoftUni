...
router.get('/create', isAuth, (req, res) => {
    // isAuth -> you cannot enter in create if you are not logged/auth/ user
...
router.post(
    ...
    body('difficultyLevel', 'Diffciculty level is required to be in range 1 to 6').toInt().isInt({ min: 1, max: 6 }),
    (req, res) => {
        const cube = req.body;
