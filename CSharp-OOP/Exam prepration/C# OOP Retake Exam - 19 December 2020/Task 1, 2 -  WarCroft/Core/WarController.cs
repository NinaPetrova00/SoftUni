    ...
    public class WarController
    {
        ...
        public string GetStats()
        {
            ...
            foreach (var item in characters)
            {
                sb.AppendLine(string.Format(SuccessMessages.CharacterStats,
                    item.Name, item.Health, item.BaseHealth, item.Armor, item.BaseArmor,
        ...
        public string Attack(string[] args)
        {
            ...
            Character receiver = characterParty
                  .FirstOrDefault(c => c.Name == args[1]);
            ...
            string output = string.Format(SuccessMessages.AttackCharacter,
                   warrior.Name, receiver.Name,
                   warrior.AbilityPoints, receiver.Name,
                   receiver.Health, receiver.BaseHealth,
        ...
        public string Heal(string[] args)
        {
            ...
            return string.Format(SuccessMessages.HealCharacter,
                priest.Name, receiver.Name,
                priest.AbilityPoints, receiver.Name, receiver.Health);
        }
    }
}
