namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportEmployees(TeisterMaskContext context, string jsonString)
        {
            ...
            ImportImportEmployeeDto[] employeeDtos =
                JsonConvert.DeserializeObject<ImportImportEmployeeDto[]>(jsonString);

            HashSet<Employee> validEmployees = new HashSet<Employee>();

            foreach (ImportImportEmployeeDto employeeDto in employeeDtos)
            {
